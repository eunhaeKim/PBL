...
<head>
	...
	<script src="schedule.html" type="text/html"></script>
</head>
<body>
	<div class="group" id="popupGroup">
		...
		<div class="group-body">
			<form id="scheduleData">
				...
				<div class="domain">
					<textarea class="memo" id="memo" rows="5" cols="20" placeholder="간단한 메모를 입력하세요"></textarea>
				</div>
			</form>

			<button class="ok-button" type="button" onclick="click_ok();"> 저장 </button>
		</div>
	</div>
